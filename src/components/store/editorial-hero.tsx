...
export function EditorialHero({ items }: { items: HeroItem[] }) {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#0c0a06] text-[#f3e9d8]">
      ...
      <span
        aria-hidden
        className="pointer-events-none absolute -top-2 left-1/2 -z-10 -translate-x-1/2 select-none font-heading text-[28vw] font-bold leading-none text-white/[0.04] sm:text-[22vw]"
      >
        POSTED
      </span>
      ...
      <div className="mx-auto grid min-h-[88vh] max-w-6xl grid-cols-1 items-center gap-8 px-4 py-20 sm:px-6 lg:min-h-[92vh] lg:grid-cols-[1fr_1.05fr]">
        ...
        <div className="relative z-10">
          <div className="flex items-end gap-4">
            ...
            <span className="stamp-label mb-2 text-white/55">
        ...
        <div className="relative z-10 flex items-center justify-center">
          ...
          <div className="absolute -bottom-5 right-0 z-20 flex gap-2">
            <button
              ...
              onClick={() => go(-1)}
              className="grid size-10 place-items-center rounded-full ring-1 ring-white/20 text-white/80 transition-colors hover:bg-white/10 hover:text-white focus-visible:ring-2 focus-visible:ring-primary"
            >
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-6 z-10 flex justify-center">
        <ChevronDown
          className={
            reduce
              ? "size-6 text-white/40"
              : "size-6 animate-bounce text-white/40"
          }
        />
      </div>
    </section>
